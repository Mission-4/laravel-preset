...
class TailwindCssPreset extends Preset
{
    ...
    protected static function updateStyles()
    {
        ...
        copy(__DIR__ . '/tailwindcss-stubs/resources/css/src.css', resource_path('css/src.css'));
    }
    ...
    protected static function updateBootstrapping()
    {
        ...
        copy(__DIR__ . '/tailwindcss-stubs/resources/js/src.js', resource_path('js/src.js'));
